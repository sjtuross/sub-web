        ...
        remoteConfig: [
          {
            ...
            options: [
              ...
              {
                label: "ACL4SSR_Online_Mini_MultiCountry 带港美日国家 (与Github同步)",
              ...
              {
                label: "ACL4SSR_Online_Full_MultiMode 全分组 自动测速、故障转移、负载均衡 重度用户使用 (与Github同步)",
              ...
              {
                label: "ACL4SSR_Mini_MultiMode 本地 精简版 自动测速、故障转移、负载均衡",
                value: "config/ACL4SSR_Mini_MultiMode.ini"
              },
              {
                label: "ACL4SSR_Mini_NoAuto 本地 精简版 无自动测速",
                value: "config/ACL4SSR_Mini_NoAuto.ini"
              },
              {
                label: "ACL4SSR_Mini_Fallback 本地 精简版 带故障转移",
              ...
              {
                label: "ACL4SSR_NoAuto_NoApple_NoMicrosoft 本地 无自动测速 无苹果分流 无微软分流",
              ...
              {
                label: "ACL4SSR_WithChinaIp 本地 增强中国",
                value: "config/ACL4SSR_WithChinaIp.ini"
              },
              {
                label: "ACL4SSR_WithChinaIp_WithGFW 本地 增强中国 GFW列表",
